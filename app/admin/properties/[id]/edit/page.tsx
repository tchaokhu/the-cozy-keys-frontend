    ...
    <div className="min-h-screen flex" style={{ background: 'var(--cream)' }}>
      ...
      <main className="flex-1 p-8 overflow-auto">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="font-serif text-2xl font-bold" style={{ color: 'var(--brown)' }}>แก้ไขทรัพย์</h1>
            <p className="text-sm font-light" style={{ color: 'var(--text-light)' }}>อัปเดตข้อมูลทรัพย์</p>
          </div>
        </div>
