...
ดูรายการ env vars ปัจจุบันใน `CLAUDE.md` ส่วน "Required environment variables".
สำหรับ deploy production ให้ดู `SECURITY_TODO.md` ส่วน "Pre-deploy checklist".
...
- K. Nut: 087 670 6436
- K. Dear: 098 091 5461
- LINE: [lin.ee/ZhDShaPc](https://lin.ee/ZhDShaPc)
